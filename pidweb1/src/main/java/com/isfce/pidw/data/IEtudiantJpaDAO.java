...
public interface IEtudiantJpaDAO extends IUsersJpaDAO<Etudiant> {
	...
	@Query(value="	select ev.RESULTAT, e.EMAIL,e.NOM,e.PRENOM,e.TEL, u.*  from TETUDIANT e \r\n" + 
			...
			"	where ev.RESULTAT <  50 AND i.FKMODULE=?", nativeQuery=true)
	List<Etudiant> get2ndSessionEtudiantsOfModule(String code);
