...
function sortTable2() {
  ...
  while (switching) {
    ...
    for (i = 1; i < (rows.length - 1); i++) {
      ...
      if(orderby) { 
      x = 	rows[rows.length - i].getElementsByClassName("divTableCell")[0];   //	rows[i].getElementsByTagName("TD")[0];
      y = rows[rows.length - (i+1)].getElementsByClassName("divTableCell")[0];   //	rows[i + 1].getElementsByTagName("TD")[0];
      } else {
      x = 	rows[i].getElementsByClassName("divTableCell")[0];   //	rows[i].getElementsByTagName("TD")[0];
      y = rows[i+1].getElementsByClassName("divTableCell")[0];   //	rows[i + 1].getElementsByTagName("TD")[0];
      }
